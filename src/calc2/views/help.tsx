				...
				* the relation _PremiumCustomers_ contains the customer-ids of all customers with a total balance over
				...
				`}</code>
							...
							<p>For example the simple bank definition of this tutorial has been published as a <a
								...
								2cfb981fbc5676182d64</a> and can therefore be loaded directly with modifying the url by replacing all after <code>DOMAIN/relax-modified/calc/</code> with <code>/gist/2cfb981fbc5676182d64</code>.</p>
